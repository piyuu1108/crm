...
export default function AdminStudentDetailPage() {
  ...
  const { data, isLoading, isError, error } = useAdminStudentDetailQuery(studentDbId);
  const verifyMutation = useAdminStudentVerificationMutation();
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      <div className="flex items-center justify-between">
        <Button
          variant="secondary"
          onPress={() => router.push(`/app/admin/divisions/${divisionId}`)}
        >
