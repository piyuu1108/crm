...
<div class="flex justify-center p-6">
	<div class="w-full max-w-4xl space-y-6">
		...
		<div class="flex items-center gap-3">
			<Button variant="outline" size="icon" href="/app/students" class="size-9 shrink-0">
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
			...
			<div class="lg:col-span-2">
				<Card.Root>
					<Card.Header>
						...
						<Card.Description>
							Fill in the required information to create a student account.
						</Card.Description>
					</Card.Header>
					...
					<Card.Content>
						...
						>
							...
							{#if form?.message}
								<div
									class="bg-destructive/10 text-destructive flex items-center gap-2 rounded-lg px-4 py-3 text-sm font-medium"
								>
									<svg class="size-4 shrink-0" viewBox="0 0 16 16" fill="currentColor">
										<path
											d="M8 1a7 7 0 100 14A7 7 0 008 1zm0 2a1 1 0 011 1v4a1 1 0 01-2 0V4a1 1 0 011-1zm0 8a1 1 0 100-2 1 1 0 000 2z"
										/>
									</svg>
			...
			<div class="lg:col-span-2">
				<Card.Root>
					...
					<Card.Content class="text-muted-foreground space-y-4 text-sm">
